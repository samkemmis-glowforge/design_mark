...
async function main() {
  ...
  const html = `<!doctype html><html><head><meta charset="utf-8"><style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .photo{position:absolute;left:50%;bottom:30px;transform:translateX(-50%);width:1380px}
    ...
    .logo{position:absolute;left:50%;transform:translateX(-50%);bottom:54px}
    ...
    <div class="stage">
      ...
      <div class="txt">
        ...
        <div class="rule"></div>
        <div class="prod">Proofgrade&trade;</div>
      </div>
